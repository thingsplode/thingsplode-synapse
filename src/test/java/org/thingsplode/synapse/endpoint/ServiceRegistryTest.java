...
public class ServiceRegistryTest {
    ...
    public void testRequestMethodDispatching() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, MarshallerException, SerializationException {
        ...
        ///----------------------------
        assertResponse(registry.invoke(new Request.RequestHeader(null, new Uri("/1221221/devices/add"), RequestMethod.POST), null));
        assertResponse(registry.invoke(new Request.RequestHeader(null, new Uri("/1221221/devices/add"), RequestMethod.PUT), null));
    }
    ...
    public void testMultipleUrisSameMethod() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        ...
        ///----------------------------
        Response<Integer> rsp = registry.invoke(new Request.RequestHeader(null, new Uri("/test/user.name/messages/calculate?a=2&b=3"), RequestMethod.GET), null);
        Assert.assertTrue(rsp.getBody() == 5);

        Response<Integer> rsp2 = registry.invoke(new Request.RequestHeader(null, new Uri("/test/user.name/messages/add?a=1231434&b=212112"), RequestMethod.GET), null);
    ...
    public void testRequestBody() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        ...
        Response<Address> rsp1 = registry.invoke(new Request.RequestHeader(null, new Uri("/test/user.name/messages/check_address"), RequestMethod.GET), new Address(street, country, 4040));
        ...
        Response<Device> rsp2 = registry.invoke(new Request.RequestHeader(null, new Uri("/user.name/devices/getById"), RequestMethod.GET), new Long(112));
    ...
    public void testMissingParams() throws MethodNotFoundException, ExecutionException, MissingParameterException, UnsupportedEncodingException, SerializationException {
        //todo: reenable this
        Response<Integer> rsp1 = registry.invoke(new Request.RequestHeader(null, new Uri("/test/user.name/messages/add"), RequestMethod.GET), null);
        Response<Integer> rsp2 = registry.invoke(new Request.RequestHeader(null, new Uri("/test/user.name/messages/add?a=1231434"), RequestMethod.GET), null);
        Response<Integer> rsp3 = registry.invoke(new Request.RequestHeader(null, new Uri("/test/user.name/messages/add?a=1231434&b="), RequestMethod.GET), null);
        Response<Integer> rsp4 = registry.invoke(new Request.RequestHeader(null, new Uri("/test/user.name/messages/add?a=1231434&b=null"), RequestMethod.GET), null);
    ...
    public void testPathVariableResolution1() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        ...
        //([A-Za-z0-9._@]+)$
        Response<Integer> rsp = registry.invoke(new Request.RequestHeader(null, new Uri("/test/user.name/messages/clear"), RequestMethod.GET), null);
    ...
    public void testPathVariableResolution2() throws MethodNotFoundException, ExecutionException, MissingParameterException, UnsupportedEncodingException, SerializationException {
        ...
        //(?!/)([.a-z0-9]+)(?=/devices/)
        Response<Device> rsp = registry.invoke(new Request.RequestHeader(null, new Uri("/1212212/devices/2323434"), RequestMethod.GET), null);
        Assert.assertTrue(rsp.getHeader().getResponseCode() == HttpResponseStatus.OK);
        ...
        Response<Device> rsp1 = registry.invoke(new Request.RequestHeader(null, new Uri("/1212212/devices/switches/1998"), RequestMethod.GET), null);
        Optional<ServiceRegistry.MethodContext> opt1 = registry.getMethodContext(new Request.RequestHeader(null, new Uri("/test/user.name/messages/add?a=1231434&b=212112"), RequestMethod.GET));
    ...
    public void testPathVariableResolution3() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        ...
        Response<Device> rsp = registry.invoke(new Request.RequestHeader(null, new Uri("/1212212/devices/getById/1122321"), RequestMethod.GET), null);
        Assert.assertTrue(rsp.getHeader().getResponseCode() == HttpResponseStatus.OK);
    ...
    public void testNotImplemented() throws MethodNotFoundException, ExecutionException, MissingParameterException, UnsupportedEncodingException, SerializationException {
        ...
        Response rspX = registry.invoke(new Request.RequestHeader(null, new Uri("/test/user/name/messages/clear"), RequestMethod.GET), null);
        Optional<ServiceRegistry.MethodContext> opt1 = registry.getMethodContext(new Request.RequestHeader(null, new Uri("/test/user.name/messages/add?a=1231434&b=212112"), RequestMethod.GET));
    ...
    public void testOverloadedMethods() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        ...
        Response<Device> rsp1 = registry.invoke(new Request.RequestHeader(null, new Uri("/222/devices/owner"), RequestMethod.GET), null);
        Assert.assertTrue(rsp1.getHeader().getResponseCode() == HttpResponseStatus.OK);
        ...
        Response<Device> rsp2 = registry.invoke(new Request.RequestHeader(null, new Uri("/222/devices/owner?arg0=222"), RequestMethod.GET), null);
        Optional<ServiceRegistry.MethodContext> opt1 = registry.getMethodContext(new Request.RequestHeader(null, new Uri("/test/user.name/messages/add?a=1231434&b=212112"), RequestMethod.GET));
        ...
        Response<Device> rsp3 = registry.invoke(new Request.RequestHeader(null, new Uri("/222/devices/owner?arg0=222&arg1=114"), RequestMethod.GET), null);
        ...
        Response<Device> rsp4 = registry.invoke(new Request.RequestHeader(null, new Uri("/222/devices/owner/old"), RequestMethod.GET), null);
    ...
    public void testReqMethodWithReqMapping() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        ...
        Response<Integer> rsp1 = registry.invoke(req.getHeader(), req);
        Assert.assertTrue(rsp1.getHeader().getResponseCode() == HttpResponseStatus.OK);
        ...
        Response<ArrayList<Device>> rsp2 = registry.invoke(new Request.RequestHeader(null, new Uri("/some_user/devices/listAll"), RequestMethod.GET), null);
        Assert.assertTrue(rsp2.getHeader().getResponseCode() == HttpResponseStatus.OK);
    ...
    public void testInterfaceMarkedServices() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        ...
        Response<String> rsp1 = registry.invoke(new Request.RequestHeader(null, new Uri("/com/acme/synapse/testdata/services/DummyMarkedEndpoint/echo"), RequestMethod.GET), ParameterWrapper.create().add("arg0", String.class, "\"something in the rain\""));
        Assert.assertTrue(rsp1.getHeader().getResponseCode() == HttpResponseStatus.OK);
        Assert.assertTrue(rsp1.getBody().equalsIgnoreCase("Greetings earthlings: " + "\"something in the rain\""));

        Response<String> rsp2 = registry.invoke(new Request.RequestHeader(null, new Uri("/com/acme/synapse/testdata/services/DummyMarkedEndpoint/echo"), RequestMethod.GET), ParameterWrapper.create().add("arg0", String.class, "something in the rain"));
        Assert.assertTrue(rsp2.getHeader().getResponseCode() == HttpResponseStatus.OK);
    ...
    public void testRpcServices1() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        ...
        Response rsp = registry.invoke(new Request.RequestHeader(null, new Uri("/com/acme/synapse/testdata/services/RpcEndpointImpl/ping"), RequestMethod.GET), null);
        Assert.assertTrue(rsp.getHeader().getResponseCode() == HttpResponseStatus.OK);
        Assert.assertTrue(rsp.getBody() == null);
    }
    ...
    public void testRpcServices2() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        Response<String> rsp1 = registry.invoke(new Request.RequestHeader(null, new Uri("/com/acme/synapse/testdata/services/RpcEndpointImpl/echo"), RequestMethod.GET), ParameterWrapper.create().add("arg0", String.class, "Hello people"));
        Assert.assertTrue(rsp1.getHeader().getResponseCode() == HttpResponseStatus.OK);
    ...
    public void testRpcServices3() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        Response<Filter> rsp2 = registry.invoke(new Request.RequestHeader(null, new Uri("/com/acme/synapse/testdata/services/RpcEndpointImpl/getInfo"), RequestMethod.GET), null);
        Assert.assertTrue(rsp2.getHeader().getResponseCode() == HttpResponseStatus.OK);
    ...
    public void testRpcServices4() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException, SerializationException {
        Response<Filter> rsp3 = registry.invoke(new Request.RequestHeader(null, new Uri("/com/acme/synapse/testdata/services/RpcEndpointImpl/filter"), RequestMethod.GET), ParameterWrapper.create().add("arg0", Filter.class, new Filter("other query", Integer.MAX_VALUE, Integer.MAX_VALUE)));
        Assert.assertTrue(rsp3.getHeader().getResponseCode() == HttpResponseStatus.OK);
    ...
    public void testNegative() throws MethodNotFoundException, ExecutionException, MissingParameterException, UnsupportedEncodingException, SerializationException {
        Response<Filter> rsp1 = registry.invoke(new Request.RequestHeader(null, new Uri("/com/acme/synapse/testdata/services/RpcEndpointImpl/getInfo?arg0=some param"), RequestMethod.GET), null);
    }
