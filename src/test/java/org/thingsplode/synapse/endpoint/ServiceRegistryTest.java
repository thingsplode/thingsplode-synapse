...
public class ServiceRegistryTest {
    ...
    @Test
    public void testPathVariableResolution() throws UnsupportedEncodingException, MethodNotFoundException, ExecutionException, MissingParameterException {
        ...
        Response rsp1 = registry.invoke(RequestMethod.GET, new Uri("/test/user.name/messages/clear"), null);
        Assert.assertTrue(rsp1.getBody() == null);
