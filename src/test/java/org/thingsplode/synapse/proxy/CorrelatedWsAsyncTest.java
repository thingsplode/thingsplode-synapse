 ...
 * @author Csaba Tamas
 */
public class CorrelatedWsAsyncTest extends AbstractTest {
    ...
    public static ExternalResource clientProxy = new ExternalResource() {
        ...
        protected void before() {
            try {
                epx = EndpointProxy.create("ws://localhost:8080/", Dispatcher.DispatcherPattern.CORRELATED_ASYNC).
                        enableIntrospection().
